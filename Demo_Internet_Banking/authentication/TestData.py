...
#from Demo_Internet_Banking.authentication.TestData_Properties import General_Properties, Authentication_Properties
from Demo_Internet_Banking.authentication.TestData_Properties import *
