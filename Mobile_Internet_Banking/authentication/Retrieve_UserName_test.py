...
@allure.testcase("Mobile Retrieve User Name Test Case")
@allure.description("Start:Internet Banking Retrieve User Name Flow. FileName: Retrieve_UserName_test.py, ClassName:Test_Retrieve_UserName, TestName:test_Retrieve_UserName")
class Test_Retrieve_UserName:
    ...
    def test_Retrieve_UserName(self, startup):
        ...
        with allure.step("STEP-5: Click on Retrieve User Name Link."):
            mobile_signIn_screen = Mobile_SignIn(self.driver)
            isElementExist = mobile_signIn_screen.click_retrieve_user_name_link()
            assert isElementExist, "Unable to Locate Element. Issue in --click_retrieve_user_name_link()---method."

        time.sleep(wait)

        with allure.step("STEP-6: Pass Member Number and Captcha."):
            mobile_retrieve_user_name = Mobile_ForgotUsername(self.driver)
            isElementExist = mobile_retrieve_user_name.enter_retrieve_user_name_captcha(login_data.retrieveUserName_MemberNo, "valid captcha")
            assert isElementExist, "Unable to Locate Element. Issue in --enter_retrieve_user_name_captcha()---method."
        ...
        with allure.step("STEP-6: Pass Retrieve User Name Password."):
            retrieve_user_name_password = Mobile_RetrieveUsernamePasswordVerify(self.driver)
            isElementExist = retrieve_user_name_password.enter_retrieve_user_name_password(login_data.retrieveUserName_Password)
            assert isElementExist, "Unable to Locate Element. Issue in --enter_retrieve_user_name_password()---method."
